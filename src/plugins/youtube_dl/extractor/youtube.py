...
class YoutubeBaseInfoExtractor(InfoExtractor):
    ...
    def _login(self):
        ...
        if re.search(r'(?i)<form[^>]* id="gaia_secondfactorform"', login_results) is not None:
            ...
            tfa_form = dict((k.encode('utf-8'), v.encode('utf-8')) for k, v in list(tfa_form_strs.items()))
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        def _map_to_format_list(urlmap):
            formats = []
            for itag, video_real_url in list(urlmap.items()):
                dct = {
                    'format_id': itag,
                    'url': video_real_url,
        ...
        if self._downloader.params.get('youtube_include_dash_manifest', True):
            ...
            for dash_manifest_url in dash_mpds:
                ...
                if dash_formats:
                    ...
                    # example.
                    formats = [f for f in formats if f['format_id'] not in list(dash_formats.keys())]
                    formats.extend(list(dash_formats.values()))
...
class YoutubeChannelIE(InfoExtractor):
    ...
    def extract_videos_from_page(page):
        ...
        return list(zip(ids_in_page, titles_in_page))
