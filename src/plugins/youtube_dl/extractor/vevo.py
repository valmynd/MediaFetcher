...
class VevoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        info_json = self._download_webpage(json_url, video_id, 'Downloading json info')
        links_webpage = self._download_webpage(videos_url, video_id, 'Downloading videos urls')
