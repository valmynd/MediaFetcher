...
class NocoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        for audio_lang, audio_lang_dict in list(medias.items()):
            preference = 1 if audio_lang == audio_lang_pref else 0
            for sub_lang, lang_dict in list(audio_lang_dict['video_list'].items()):
                for format_id, fmt in list(lang_dict['quality_list'].items()):
        ...
        thumbnails = []
        for thumbnail_key, thumbnail_url in list(show.items()):
