...
class CinemassacreIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        url = self._html_search_regex(r'\'streamer\': \'(?P<url>[^\']+)\'', playerdata, 'url')

        sd_file = self._html_search_regex(r'\'file\': \'(?P<sd_file>[^\']+)\'', playerdata, 'sd_file')
        hd_file = self._html_search_regex(r'\'?file\'?: "(?P<hd_file>[^"]+)"', playerdata, 'hd_file')
