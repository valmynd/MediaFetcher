...
class TF1IE(InfoExtractor):
    ...
    _TEST = {
        ...
        'file': '10635995.mp4',
        'md5': '2e378cc28b9957607d5e88f274e637d8',
        'info_dict': {
        ...
        'skip': 'Sometimes wat serves the whole file with the --test option',
    }
    ...
    def _real_extract(self, url):
        ...
        embed_url = self._html_search_regex(r'"(https://www.wat.tv/embedframe/.*?)"',
                                webpage, 'embed url')
        embed_page = self._download_webpage(embed_url, id, 'Downloading embed player page')
        wat_id = self._search_regex(r'UVID=(.*?)&', embed_page, 'wat id')
        wat_info = self._download_webpage('http://www.wat.tv/interface/contentv3/%s' % wat_id, id, 'Downloading Wat info')
