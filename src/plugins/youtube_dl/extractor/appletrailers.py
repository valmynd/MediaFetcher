...
class AppleTrailersIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        playlist_cleaned = re.sub(r'(?s)<script[^<]*?>.*?</script>', '', playlist_snippet)
        ...
        playlist_html = '<html>' + playlist_cleaned + '</html>'
        ...
        for li in doc.findall('./div/ul/li'):
            ...
            settings_json = self._download_webpage(settings_json_url, trailer_id, 'Downloading settings json')
