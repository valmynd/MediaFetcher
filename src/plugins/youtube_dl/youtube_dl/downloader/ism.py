...
def write_piff_header(stream, params):
	...
	trak_payload = full_box(b'tkhd', 1, TRACK_ENABLED | TRACK_IN_MOVIE | TRACK_IN_PREVIEW,
	...
	if is_audio:
		...
		if fourcc in ('H264', 'AVC1'):
			...
			avcc_payload += u8.pack(0xfc | (params.get('nal_unit_length_field',
																								 4) - 1))  # complete represenation (1) + reserved (11111) + length size minus one
