...
try:
    compat_basestring = str  # Python 2
except NameError:
...
try:
    ...
    def compat_kwargs(kwargs):
        return dict((bytes(k), v) for k, v in list(kwargs.items()))
else:
...
def workaround_optparse_bug9161():
    ...
    try:
        ...
        def _compat_add_option(self, *args, **kwargs):
            ...
            bkwargs = dict(
                (k, enc(v)) for k, v in list(kwargs.items()))
...
if hasattr(shutil, 'get_terminal_size'):  # Python >= 3.3
    ...
    def compat_get_terminal_size():
        ...
        try:
            ...
            lines, columns = list(map(int, out.split()))
        except Exception:
            pass
