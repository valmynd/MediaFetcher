...
class DreiSatIE(InfoExtractor):
    ...
    _TEST = {
        ...
        'file': '36983.webm',
        'md5': '57c97d0469d71cf874f6815aa2b7c944',
        'info_dict': {
            "title": "Kaffeeland Schweiz",
            "description": "Über 80 Kaffeeröstereien liefern in der Schweiz das Getränk, in das das Land so vernarrt ist: Mehr als 1000 Tassen trinkt ein Schweizer pro Jahr. SCHWEIZWEIT nimmt die Kaffeekultur unter die...", 
            "uploader": "3sat",
    ...
    def _real_extract(self, url):
        ...
        details_xml = self._download_webpage(details_url, video_id, note='Downloading video details')
